...
INSERT INTO "new_EmailLog" ("errorMessage", "id", "jobPosition", "recipientId", "sentAt", "status") SELECT "errorMessage", "id", "jobPosition", "recipientId", "sentAt", "status" FROM "EmailLog";
DROP TABLE "EmailLog";
